    ...
    static let definitions: [ScenePackDefinition] = [
        ScenePackDefinition(
            ...
            tiers: [
                ...
                ScenePackTier(maxAmount: 30, notes: ["雨天打车通勤", "加班后打车回家", "共享单车月卡里的一天", "停车/充电小费用", "今天路程稍长一点", "路上多花了一点时间", "早晚两次出行", "这一程走完了"]),
        ...
        ScenePackDefinition(
            ...
            category: .daily,
            tiers: [
                ScenePackTier(maxAmount: 20, notes: ["超市买点小东西", "纸巾清洁补一点", "便利店顺手补货", "今天给家补点", "买菜顺带一件日用", "小袋子放进日常", "缺的东西补上", "家用小补给"]),
        ...
        ScenePackDefinition(
            ...
            tiers: [
                ...
                ScenePackTier(maxAmount: 60, notes: ["药店买药", "挂号问诊的一次记录", "换季护理用品补上", "牙膏牙线和口腔护理", "健身装备小添置", "身体提醒先记下", "运动场地或课程一回", "小病小痛记下"]),
                ScenePackTier(maxAmount: 200, notes: ["一次检查", "牙科护理的一段记录", "理疗/康复一次", "体检项目先记下来", "训练装备升级一点", "恢复按摩安排一次", "问诊和用药都记清楚", "身体状态认真照顾"]),
                ScenePackTier(maxAmount: 9_999, notes: ["体检套餐", "牙科治疗的一笔重要开销", "医院检查与治疗相关", "健身年卡或大课包", "恢复相关安排", "运动装备大件添置", "身体相关大笔支出", "长期护理和训练安排"]),
            ]
        ),
        ScenePackDefinition(
            id: "home",
            ...
            tiers: [
                ...
                ScenePackTier(maxAmount: 80, notes: ["水电燃气的一笔日常", "宽带/话费这类日常", "家里实用小物", "住处运转的小日常", "家里的小维护", "物业相关记一下", "维修小费用", "居家小安排"]),
