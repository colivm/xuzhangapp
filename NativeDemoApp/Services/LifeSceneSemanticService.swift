...
enum LifeSceneSemanticService {
    ...
    private static func signals(
        ...
        if containsAny(text, ["买菜", "食材", "盒马", "叮咚", "小象超市", "京东到家", "京东秒送", "朴朴", "菜场", "水果", "厨房", "饭桌", "生鲜", "蔬菜", "淘宝买菜", "美团买菜", "牛奶", "鲜奶", "纯牛奶", "酸奶", "认养一头牛", "特仑苏", "伊利", "蒙牛", "光明", "金典", "简爱", "悦鲜活", "a2", "奶粉", "奶"]) {
        ...
        if containsAny(text, ["电影", "影院", "游戏", "演唱会", "音乐节", "剧场", "展", "博物馆", "ktv", "唱歌", "桌游"]) {
