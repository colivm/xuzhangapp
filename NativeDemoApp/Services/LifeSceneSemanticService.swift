...
enum LifeSceneSemanticService {
    ...
    private static func signals(
        ...
        if containsAny(text, ["打车", "出租", "网约车", "滴滴", "花小猪", "单车", "骑车", "停车", "洗车", "汽车保养", "车辆保养", "保养车", "etc", "ETC", "车票", "高铁", "火车", "机场", "航班", "过路费", "路费", "充电", "充电桩"]) {
        ...
        if containsAny(text, ["保洁", "家政", "钟点工", "开荒保洁", "网上国网", "国网", "暖气费", "取暖费", "水费", "电费", "燃气", "物业", "宽带"]) {
            add(.homeSupply, 6.5, .home, "居家账单", "#居家安排", 35)
        }
        if containsAny(text, ["宝宝", "孩子", "婴儿", "奶粉", "尿不湿", "纸尿裤", "拉拉裤", "辅食", "奶瓶", "安抚奶嘴", "宝宝湿巾", "婴儿湿巾", "童装", "儿童座椅", "推车", "宠物", "毛孩子", "毛孩", "狗粮", "猫粮", "猫砂", "宠物粮", "宠物口粮", "尿垫", "冻干", "宠物罐头", "驱虫", "宠物医院", "洗护"]) {
        ...
        if containsAny(text, ["医院", "门诊", "诊所", "挂号", "问诊", "体检", "检查", "拍片", "验血", "口腔", "牙科", "洗牙", "配镜", "验光"]) {
        ...
        if containsAny(text, ["酒店", "宾馆", "民宿", "住宿", "客栈", "房费", "续住"]) {
            add(.lodging, 6.6, .lodging, "停留住宿", "#住宿", 50)
        }
        if containsAny(text, ["红包", "礼物", "送礼", "份子", "随礼", "生日", "探望", "拜访", "请客", "聚餐", "朋友"]) {
            add(.social, 6.3, .social, "人情往来", "#人情", 55)
        }
        if containsAny(text, ["电影", "影院", "游戏", "B站会员", "哔哩哔哩会员", "爱奇艺会员", "网易云会员", "网易云音乐会员", "演唱会", "音乐节", "剧场", "展", "博物馆", "ktv", "唱歌", "桌游"]) {
