...
enum RecordSemanticLexicon {
    ...
    private static let minimalFallbackPayload = RecordSceneLexiconPayload(
        version: 0,
        keywordRules: [
            .init(category: .transport, score: 4.0, keywords: ["地铁", "公交", "打车", "滴滴", "花小猪", "洗车", "汽车保养", "车辆保养", "保养车", "ETC", "etc", "充车", "充电桩", "电车充电", "汽车充电", "车辆充电", "新能源充电", "补能", "高铁", "机票", "机场", "路费", "到站", "早高峰", "晚高峰", "顺利到达", "准时出门", "车程", "通勤"]),
        ...
        ocrKeywordRules: [
            ...
            .init(category: .entertainment, score: 3.5, keywords: ["网吧", "网咖", "上网费", "直播打赏", "主播打赏", "抖音打赏", "直播礼物"]),
            .init(category: .lodging, score: 3.5, keywords: ["电竞酒店"]),
            .init(category: .other, score: 3.0, keywords: ["驾校", "驾校报名费", "驾考", "学车", "彩票", "福彩", "体彩", "刮刮乐"])
        ],
        comboRules: [
