...
enum RecordSemanticLexicon {
    ...
    private static let minimalFallbackPayload = RecordSceneLexiconPayload(
        version: 0,
        keywordRules: [
            .init(category: .transport, score: 4.0, keywords: ["地铁", "公交", "打车", "滴滴", "充电", "充电桩", "高铁", "机票", "机场", "路费"]),
            .init(category: .dining, score: 4.8, keywords: ["咖啡", "奶茶", "早餐", "午餐", "晚餐", "外卖", "饭", "饮品", "拿铁", "美式"]),
        ...
        emotionKeywordRules: [
            ...
            .init(id: "meal", category: .dining, keywords: ["食堂", "午餐", "简餐", "热饭", "外卖", "饭点", "夜宵", "晚饭", "早餐"]),
