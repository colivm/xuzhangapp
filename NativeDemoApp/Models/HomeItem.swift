...
struct HomeItem: Identifiable, Codable, Equatable {
    ...
    static func lateNightDiningEmotionTag(title: String, date: Date?) -> String? {
        ...
        let hasWorkCue = containsAny(text, ["加班", "下班后", "工作", "公司", "单位", "工位"])
        if hasWorkCue {
        ...
        if text.contains("晚归") {
            return containsAny(text, ["饭", "餐", "吃", "外卖", "小食", "点心", "热乎", "热食"])
                ? "晚归时吃点东西"
                : "夜里这笔记下"
        }
...
enum RecordSemanticLexicon {
    ...
    private static let minimalFallbackPayload = RecordSceneLexiconPayload(
        ...
        ocrKeywordRules: [
            .init(category: .dining, score: 4.5, keywords: ["海底捞", "老乡鸡", "塔斯汀", "库迪", "库迪咖啡", "东方树叶", "青柑普洱", "普洱茶", "乌龙茶", "茉莉花茶", "红茶", "绿茶", "瓶装茶", "无糖茶", "绝味", "鸭脖", "周黑鸭", "袁记云饺", "萨莉亚", "生蚝", "烤生蚝", "海鲜", "花甲", "花蛤", "蛤蜊", "贝类", "鱿鱼", "铁板鱿鱼", "烤鸭", "烧鸭", "卤鸭", "鸭肉", "鸡爪", "凤爪", "花甲鸡爪", "烧烤", "夜市", "大排档", "鸭血粉丝汤", "鸭血粉丝", "灌汤包", "小笼汤包", "汤包", "牛肉面", "兰州牛肉面", "兰州拉面", "拉面", "汤面", "面馆", "面食", "面条"]),
        ...
        emotionKeywordRules: [
            ...
            .init(id: "meal", category: .dining, keywords: ["食堂", "午餐", "午饭", "简餐", "轻食", "小食", "点心", "热饭", "外卖", "饭点", "吃一口", "夜宵", "晚饭", "早餐", "早饭", "肠粉", "黄焖鸡", "冒菜", "生煎", "锅贴", "七欣天", "海底捞", "老乡鸡", "塔斯汀", "绝味", "鸭脖", "鸭货", "袁记云饺", "萨莉亚", "火锅", "烤肉", "烤鸭", "烧鸭", "卤鸭", "鸭肉", "鸡爪", "凤爪", "花甲鸡爪", "麻辣烫", "卤味", "生蚝", "烤生蚝", "花甲", "花蛤", "蛤蜊", "贝类", "鱿鱼", "铁板鱿鱼", "烧烤", "夜市", "大排档", "便当", "盖饭", "鸭血粉丝汤", "鸭血粉丝", "灌汤包", "小笼汤包", "汤包", "牛肉面", "兰州牛肉面", "兰州拉面", "拉面", "汤面", "面馆", "面食", "面条", "粉面"]),
