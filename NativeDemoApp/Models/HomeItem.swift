...
enum RecordSemanticLexicon {
    ...
    private static let minimalFallbackPayload = RecordSceneLexiconPayload(
        ...
        keywordRules: [
            ...
            .init(category: .dining, score: 4.8, keywords: ["咖啡", "奶茶", "早餐", "早饭", "午餐", "午饭", "晚餐", "晚饭", "夜宵", "宵夜", "外卖", "饭", "餐", "一顿", "这顿", "吃", "垫一下", "垫一口", "夜里补", "热食", "热乎", "轻食", "小食", "点心", "补点能量", "吃一口", "饮品", "拿铁", "美式", "肠粉", "黄焖鸡", "冒菜", "生煎", "锅贴", "七欣天", "海底捞", "老乡鸡", "塔斯汀", "库迪", "绝味", "鸭脖", "鸭货", "周黑鸭", "煌上煌", "袁记云饺", "萨莉亚", "火锅", "麻辣烫", "披萨", "炸鸡", "汉堡", "卤味", "生蚝", "烤生蚝", "海鲜", "鱿鱼", "铁板鱿鱼", "烧烤", "夜市", "夜摊", "大排档", "小吃", "美团外卖", "饿了么"]),
        ...
        ocrKeywordRules: [
            .init(category: .dining, score: 4.5, keywords: ["海底捞", "老乡鸡", "塔斯汀", "库迪", "库迪咖啡", "绝味", "鸭脖", "周黑鸭", "袁记云饺", "萨莉亚", "生蚝", "烤生蚝", "海鲜", "鱿鱼", "铁板鱿鱼", "烧烤", "夜市", "大排档"]),
        ...
        emotionKeywordRules: [
            ...
            .init(id: "meal", category: .dining, keywords: ["食堂", "午餐", "午饭", "简餐", "轻食", "小食", "点心", "热饭", "外卖", "饭点", "吃一口", "夜宵", "晚饭", "早餐", "早饭", "肠粉", "黄焖鸡", "冒菜", "生煎", "锅贴", "七欣天", "海底捞", "老乡鸡", "塔斯汀", "绝味", "鸭脖", "鸭货", "袁记云饺", "萨莉亚", "火锅", "麻辣烫", "卤味", "生蚝", "烤生蚝", "鱿鱼", "铁板鱿鱼", "烧烤", "夜市", "大排档", "便当", "盖饭"]),
