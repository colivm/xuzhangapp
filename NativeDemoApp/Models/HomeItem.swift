...
enum RecordSemanticLexicon {
    ...
    private static let strongManualNoteOverrideRules: [(category: HomeItem.Category, keywords: [String])] = [
        (.dining, ["茶叶蛋", "饭团", "关东煮", "便当", "三明治", "肠粉", "黄焖鸡", "冒菜", "生煎", "锅贴", "咖啡", "奶茶", "拿铁", "美式", "鸭血粉丝汤", "鸭血粉丝", "灌汤包", "小笼汤包", "汤包", "牛肉面", "兰州牛肉面", "兰州拉面", "拉面", "汤面", "面馆", "面食"]),
    ...
    private static let minimalFallbackPayload = RecordSceneLexiconPayload(
        ...
        ocrKeywordRules: [
            .init(category: .dining, score: 4.5, keywords: ["海底捞", "老乡鸡", "塔斯汀", "库迪", "库迪咖啡", "绝味", "鸭脖", "周黑鸭", "袁记云饺", "萨莉亚", "生蚝", "烤生蚝", "海鲜", "鱿鱼", "铁板鱿鱼", "烤鸭", "烧鸭", "卤鸭", "鸭肉", "烧烤", "夜市", "大排档", "鸭血粉丝汤", "鸭血粉丝", "灌汤包", "小笼汤包", "汤包", "牛肉面", "兰州牛肉面", "兰州拉面", "拉面", "汤面", "面馆", "面食", "面条"]),
