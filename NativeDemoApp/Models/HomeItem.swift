...
enum RecordSemanticLexicon {
    ...
    private static let strongManualNoteOverrideRules: [(category: HomeItem.Category, keywords: [String])] = [
        (.dining, ["茶叶蛋", "饭团", "关东煮", "便当", "三明治", "肠粉", "黄焖鸡", "冒菜", "生煎", "锅贴", "咖啡", "奶茶", "拿铁", "美式", "东方树叶", "青柑普洱", "普洱茶", "乌龙茶", "茉莉花茶", "红茶", "绿茶", "瓶装茶", "无糖茶", "鸭血粉丝汤", "鸭血粉丝", "灌汤包", "小笼汤包", "汤包", "牛肉面", "兰州牛肉面", "兰州拉面", "拉面", "汤面", "面馆", "面食"]),
    ...
    private static let minimalFallbackPayload = RecordSceneLexiconPayload(
        ...
        ocrKeywordRules: [
            .init(category: .dining, score: 4.5, keywords: ["海底捞", "老乡鸡", "塔斯汀", "库迪", "库迪咖啡", "东方树叶", "青柑普洱", "普洱茶", "乌龙茶", "茉莉花茶", "红茶", "绿茶", "瓶装茶", "无糖茶", "绝味", "鸭脖", "周黑鸭", "袁记云饺", "萨莉亚", "生蚝", "烤生蚝", "海鲜", "鱿鱼", "铁板鱿鱼", "烤鸭", "烧鸭", "卤鸭", "鸭肉", "烧烤", "夜市", "大排档", "鸭血粉丝汤", "鸭血粉丝", "灌汤包", "小笼汤包", "汤包", "牛肉面", "兰州牛肉面", "兰州拉面", "拉面", "汤面", "面馆", "面食", "面条"]),
        ...
        emotionKeywordRules: [
            ...
            .init(id: "drink", category: .dining, keywords: ["饮料", "喝的", "可乐", "雪碧", "汽水", "果汁", "茶饮", "东方树叶", "青柑普洱", "普洱茶", "乌龙茶", "茉莉花茶", "红茶", "绿茶", "瓶装茶", "无糖茶", "奶茶", "咖啡", "拿铁", "美式", "冰饮", "水溶", "c100", "维C", "维c", "维他"]),
            .init(id: "transport", category: .transport, keywords: ["地铁", "公交", "打车", "出租", "网约车", "路费", "车程", "通勤", "上班", "下班", "返程", "回家"]),
            .init(id: "meal", category: .dining, keywords: ["食堂", "午餐", "午饭", "简餐", "轻食", "小食", "点心", "热饭", "外卖", "饭点", "吃一口", "夜宵", "晚饭", "早餐", "早饭", "肠粉", "黄焖鸡", "冒菜", "生煎", "锅贴", "七欣天", "海底捞", "老乡鸡", "塔斯汀", "绝味", "鸭脖", "鸭货", "袁记云饺", "萨莉亚", "火锅", "烤肉", "烤鸭", "烧鸭", "卤鸭", "鸭肉", "麻辣烫", "卤味", "生蚝", "烤生蚝", "鱿鱼", "铁板鱿鱼", "烧烤", "夜市", "大排档", "便当", "盖饭", "鸭血粉丝汤", "鸭血粉丝", "灌汤包", "小笼汤包", "汤包", "牛肉面", "兰州牛肉面", "兰州拉面", "拉面", "汤面", "面馆", "面食", "面条", "粉面"]),
