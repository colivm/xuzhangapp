...
enum RecordSemanticLexicon {
    ...
    private static let strongManualNoteOverrideRules: [(category: HomeItem.Category, keywords: [String])] = [
        (.dining, ["茶叶蛋", "饭团", "关东煮", "便当", "三明治", "肠粉", "黄焖鸡", "冒菜", "生煎", "锅贴", "咖啡", "奶茶", "拿铁", "美式", "牛肉面", "兰州牛肉面", "兰州拉面", "拉面", "汤面", "面馆", "面食"]),
    ...
    private static let minimalFallbackPayload = RecordSceneLexiconPayload(
        ...
        ocrKeywordRules: [
            .init(category: .dining, score: 4.5, keywords: ["海底捞", "老乡鸡", "塔斯汀", "库迪", "库迪咖啡", "绝味", "鸭脖", "周黑鸭", "袁记云饺", "萨莉亚", "生蚝", "烤生蚝", "海鲜", "鱿鱼", "铁板鱿鱼", "烤鸭", "烧鸭", "卤鸭", "鸭肉", "烧烤", "夜市", "大排档", "牛肉面", "兰州牛肉面", "兰州拉面", "拉面", "汤面", "面馆", "面食", "面条"]),
        ...
        emotionKeywordRules: [
            ...
            .init(id: "meal", category: .dining, keywords: ["食堂", "午餐", "午饭", "简餐", "轻食", "小食", "点心", "热饭", "外卖", "饭点", "吃一口", "夜宵", "晚饭", "早餐", "早饭", "肠粉", "黄焖鸡", "冒菜", "生煎", "锅贴", "七欣天", "海底捞", "老乡鸡", "塔斯汀", "绝味", "鸭脖", "鸭货", "袁记云饺", "萨莉亚", "火锅", "烤肉", "烤鸭", "烧鸭", "卤鸭", "鸭肉", "麻辣烫", "卤味", "生蚝", "烤生蚝", "鱿鱼", "铁板鱿鱼", "烧烤", "夜市", "大排档", "便当", "盖饭", "牛肉面", "兰州牛肉面", "兰州拉面", "拉面", "汤面", "面馆", "面食", "面条", "粉面"]),
