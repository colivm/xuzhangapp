...
Assert-Pattern 'NativeDemoApp/Views/InsightWebView.swift' 'continueAICommandQuestion|aiCommandSecondaryLabel\("\u7EE7\u7EED\u95EE", systemImage: "text\.cursor"\)|aiCommandInputFocusRequest|aiCommandFocusesInputAfterResultDismissal' 'AI command result continues by returning to the preserved input'
...
Assert-Pattern 'RELEASE_GATE_AND_DEVICE_MATRIX_v1.md' 'REAL-06|FLOW-01|FLOW-20' 'product logic, theme, AI command recognition, comparison evidence, follow-up action, performance and trace gesture device matrix'
