...
Assert-Pattern 'NativeDemoApp/Views/StatsTraceModels.swift' 'enum TraceLifeMarkDetailPolicy|isHighValue\(|hidesDuplicateJourney|detailCard\(' 'high-value life assets expose stable detail and journey deduplication policy'
...
Assert-Pattern 'NativeDemoApp/Views/StatsWebView.swift' '核心证据|路线边界记录|标记出发、城市切换与返程|连续 \\(TraceClueScopePolicy\.lookbackWeekCount \+ 1\\) 周概览' 'Discover separates journey evidence roles from the rolling overview'
