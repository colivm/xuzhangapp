...
Assert-Pattern 'NativeDemoApp/Views/StatsWebView.swift' 'traceDiscoverEditorialBoard|AI 最近发现|过去的回声|traceDiscoverCard' 'Discover page renders the four editorial sections'
Assert-Pattern 'NativeDemoAppTests/StateRegressionTests.swift' 'DiscoverEditorialPolicyTests|testEmptyDiscoverSnapshotDoesNotInventCards|testRecentDiscoveriesOnlyPublishAChangeWithEvidenceAndStableRanking|testStablePresenceDoesNotBecomeARecentDiscovery|testDiscoverPublishesRecoveryWithCurrentAndHistoricalEvidence|testDiscoverPublishesDecreaseAndDisappearanceFromPriorEvidence|testDiscoverIgnoresRecordsOutsideTheBoundedRollingWindow' 'Discover change and abstention XCTest coverage'
