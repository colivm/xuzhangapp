...
Assert-Pattern 'NativeDemoAppTests/StateRegressionTests.swift' 'HomePetOverlayPositionPolicyTests|testDefaultPlacementMatchesTheLegacyLowerRightAnchor|testTapJitterDoesNotQualifyAsADrag|testDragCommitsToNearestEdgeAndKeepsVerticalPositionInBounds|testStoredPlacementNormalizesCorruptFractionsAndRestoresTheSide|testSmallViewportFallsBackWithoutProducingAnInvalidPlacement' 'pixel pet default anchor gesture threshold placement and persistence XCTest coverage'
