...
Assert-MultilinePattern 'NativeDemoApp/Views/StatsWebView.swift' 'traceLifeSliceFallbackColors[\s\S]{0,420}if AppColors\.isDarkMode[\s\S]{0,420}mix\(with: tint' 'trace fallback tiles use theme-aware dark palettes'
