...
Assert-Pattern 'NativeDemoApp/Views/InsightWebView.swift' 'ReviewTaskIntent\.allCases|reviewTaskButton|openReviewTask|先选一件要完成的事' 'review page is task-first instead of duplicate journal-first'
...
Assert-Pattern 'NativeDemoApp/Views/InsightWebView.swift' 'aiCommandComparisonOverview|aiCommandComparisonPeriodCard|aiCommandCategoryComparisonRow|aiCommandComparisonRecords' 'AI compare result uses dedicated visual comparison and grouped evidence'
...
Assert-Pattern 'RELEASE_GATE_AND_DEVICE_MATRIX_v1.md' 'REAL-06|FLOW-01|FLOW-15' 'product logic and trace gesture device matrix'
