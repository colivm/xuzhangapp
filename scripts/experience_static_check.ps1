...
Assert-Pattern 'RELEASE_GATE_AND_DEVICE_MATRIX_v1.md' 'REAL-06|FLOW-01|FLOW-19' 'product logic, theme, AI command recognition, comparison evidence, performance and trace gesture device matrix'
