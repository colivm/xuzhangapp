...
Assert-Pattern 'NativeDemoApp/Views/Components/PixelPetAnimationView.swift' 'MovablePixelPetOverlay|HomePetOverlayPositionPolicy|HomePetOverlayPositionStore|DragGesture\(minimumDistance: 10|onLongPressGesture\(minimumDuration: 0\.6' 'pixel pet supports isolated drag placement persistence and long-press hiding'
...
Assert-Pattern 'NativeDemoAppTests/StateRegressionTests.swift' 'HomePetOverlayPositionPolicyTests|testDragCommitsToNearestEdgeAndKeepsVerticalPositionInBounds|testStoredPlacementNormalizesCorruptFractionsAndRestoresTheSide|testSmallViewportFallsBackWithoutProducingAnInvalidPlacement' 'pixel pet placement and persistence XCTest coverage'
