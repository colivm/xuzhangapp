...
Assert-MultilinePattern 'NativeDemoApp/Views/Components/MemoryAttachmentViews.swift' 'private func memoryHeroImage[\s\S]{0,450}shouldLoadOriginalPage[\s\S]{0,700}variant: fitMode \? \.original : \.thumbnail' 'photo detail uses thumbnails while collapsed and original only when expanded'
