...
Assert-MultilinePattern 'NativeDemoApp/Views/StatsTraceSnapshotStore.swift' 'let journeyFact = input\.narrativeScope[\s\S]{0,1800}journeyFact: journeyFact' 'trace clue reuses the one computed journey identity'
