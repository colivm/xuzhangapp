...
Assert-MultilinePattern 'NativeDemoApp/Views/StatsWebView.swift' 'private var traceClueItems[\s\S]{0,300}TraceClueScopePolicy\.items[\s\S]{0,260}from: homeViewModel\.items' 'clue items use the continuous bounded window instead of the life period'
