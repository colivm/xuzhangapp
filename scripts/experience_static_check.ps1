...
Assert-Pattern 'NativeDemoApp/Views/HomeView.swift' 'playbackContentSnapshot = BillPlaybackSheet\.makeContentSnapshot|struct ContentSnapshot|contentSnapshot\.todayItems|contentSnapshot\.playbackMoments|contentSnapshot\.playbackDuration' 'today playback uses one immutable content snapshot'
...
Assert-Pattern 'NativeDemoAppTests/StateRegressionTests.swift' 'TodayPlaybackContentSnapshotTests|testSnapshotFreezesTodayItemsMomentsAndDurationForPlayback|testDenseSnapshotBuildsTimeBlocksOnceFromImmutableInput' 'today playback immutable snapshot XCTest coverage'
...
Assert-Pattern 'NativeDemoApp/Views/StatsWebView.swift' 'TraceDetailListSnapshotKey|TraceDetailListPreparationInput|TraceDetailListSnapshotComputation|prepareTraceDetailListSnapshot|traceDetailListSnapshot\?\.dayGroups' 'trace detail list reuses one filter snapshot'
...
Assert-Pattern 'NativeDemoAppTests/StateRegressionTests.swift' 'TraceDetailListSnapshotComputationTests|testDetailSnapshotSharesItemsIDsTotalAndDayGroupsFromOneFilterPass|testDetailSnapshotKeyChangesOnlyForLedgerOrFilterInput' 'trace detail list snapshot XCTest coverage'
