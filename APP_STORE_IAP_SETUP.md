...
| 价格（中国区） | **¥88** |
| 显示名称（简中） | `年度会员` |
| 描述（简中） | 周/月生活切片无限回看、场景备注包、OCR 不限、云端备份等。详见 App 内会员页。 |
...
```text
叙账为记账与生活回望 App。订阅解锁：周/月生活切片无限、场景备注包、OCR 不限、云端备份等。
...
> 免费：本周生活切片每自然周 1 次 · 本月生活章终生 3 次 · 今日回放每日 1 次 · OCR 每日 3 次 · 记账与基础统计免费。  
...
叙账 = 记账 + **生活切片**：把这段时间的花费讲给你听，像周记一样温柔回望。记账与基础统计始终免费。
...
3. 切到本月，试 **本月生活章**（免费用户终生共 3 次完整月章，卡片会显示剩余次数）。
4. 今日 Tab / 看看花入口，试 **今日生活回放**。
5. 播完后看会员引导是否合理；会员可无限周/月切片。

免费额度（与正式版一致）：本周生活切片每自然周 1 次 · 本月生活章终生 3 次 · 今日回放每日 1 次。

—— 其他 ——
· **无需登录**即可记账、生活切片、今日回放（数据在本地）。
...
- 记账、看看花·生活切片、今日回放、OCR、本地 AI fallback all work offline/local-first.
